...
function App() {
  ...
  return (
    // <>
    //   <h1 className='text-3xl bg-orange-500 flex justify-center items-center'>Currency Convertor</h1>
    // </>
    <div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat ' style={{
      backgroundImage: `url('https://images.pexels.com/photos/1105766/pexels-photo-1105766.jpeg?auto=compress&cs=tinysrgb&w=600')`
    }}>
